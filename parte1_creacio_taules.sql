-- Integrantes: Mariona Arenillas Vila, Alexandra Teodora Sofronie y Evelyn Aguayo Cayo
...
CREATE TABLE seient(
    ...
    FOREIGN KEY (NomPavello) REFERENCES grada(NomPavello) ON UPDATE CASCADE ON DELETE CASCADE
);
